...
export const CellWidget = observer((props: { notebookId: string; cellId: string }) => {
    return (
        <NotebookStoreContext.Provider value={store.notebooks[props.notebookId]}>
            <CellStoreContext.Provider value={store.notebooks[props.notebookId].cells[props.cellId]}>
                <CellMonitor />
