        ...
        <>
            <tr className="jobrow">
                <td className="tdstagebutton" onClick={onClickCollapseStageTable}>
                    <span className={'tdstageicon ' + (!stagesCollapsed ? 'tdstageiconcollapsed' : '')}></span>
                </td>
                ...
                <td className="tdtasks">
                    <ProgressBar total={job.numTasks} running={job.numActiveTasks} completed={job.numCompletedTasks} />
                </td>
                <td className="tdjobstarttime">
                    <ReactTimeAgo date={job.startTime} minPeriod={10} />
                </td>
                <td className="tdjobduration">
                    {job.endTime ? prettyMilliseconds(job.endTime?.getTime() - job.startTime.getTime()) : '-'}
                </td>
            </tr>
            {!stagesCollapsed && (
